package ifmg.edu.br.Finance.auth;
...
public class LoginTest {
    ...
    @Test
    void userLoginShouldReturnValidToken() throws Exception {
        ResultActions result = mockMvc.perform(post("/oauth2/token")
                .with(httpBasic(clientId, clientSecret))
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("grant_type", "password")
    ...
    @Test
    void inexistentUserShouldReturnNotFound() throws Exception {
        ResultActions result = mockMvc.perform(post("/oauth2/token")
                .with(httpBasic(clientId, clientSecret))
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("grant_type", "password")
                .param("username", nonExistingEmail)
                .param("password", "123456"));
