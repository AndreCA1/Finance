...
INSERT INTO tb_transaction (date, payee, type, status, amount, user_id) VALUES
            ('2025-06-10', 'Supermercado A', 'SPENT', 'PAID', 250.00, 1),
            ('2025-06-15', 'Restaurante B', 'SPENT', 'CARD', 100.00, 1),
            ('2025-06-05', 'Fundos MXRF11', 'INVESTMENT', 'PAID', 500.00, 1);

-- Inserção de transações para admin1
INSERT INTO tb_transaction (date, payee, type, status, amount, user_id) VALUES
            ('2025-06-12', 'Loja X', 'SPENT', 'CARD', 350.00, 2),
            ('2025-06-20', 'Viagem Y', 'SPENT', 'UNPAID', 800.00, 2),
            ('2025-06-25', 'Ações BBAS3', 'INVESTMENT', 'PAID', 1200.00, 2);
